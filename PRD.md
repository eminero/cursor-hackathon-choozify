...
2. Types natural language query:
   - Example: _"Necesito un depa de 2 cuartos en Providencia por menos de $800 con estacionamiento"_
...
- **Exact Match**: Property is eligible AND `property.zone_name` is in `tenant.preferred_zone_names`.
  - Label: _"New property in [Zone Name]"_
- **Nearby Opportunity**: Property is eligible AND within radius (e.g., 2km) of a preferred zone centroid, but NOT an exact zone match.
  - Label: _"Opportunity near your zone ([Preferred Zone])"_
...
- **Exact match**: _"New property in [Zone Name]"_
- **Nearby opportunity**: _"Opportunity near your zone ([Preferred Zone])"_ with distance indicator.
