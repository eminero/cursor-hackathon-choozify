...
2.  **"Nearby Opportunity" (Geo-Expansion):** - If a property is _outside_ the preferred zone but within a configurable radius (e.g., 2km buffer) AND the tenant is eligible, send a suggestion notification.
